...
CREATE TABLE `phuongthucthanhtoan` (
  ...
  `phuongthucthanhtoanten` varchar(255) DEFAULT NULL,
  `phuongthucthanhtoantrangthai` varchar(45) DEFAULT NULL,
...
INSERT INTO `phuongthucthanhtoan` VALUES (1,'Thanh Toán Trực Tuyến',NULL),(2,'Thanh Toán Khi Nhận Hàng',NULL);
