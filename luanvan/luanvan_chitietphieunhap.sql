...
CREATE TABLE `chitietphieunhap` (
  ...
  `chitietphieunhapsoluong` int DEFAULT NULL,
  `chitietphieunhapgianhap` float DEFAULT NULL,
  PRIMARY KEY (`idsanpham`,`idphieunhap`),
  KEY `fk_pn_idx` (`idphieunhap`),
  CONSTRAINT `fk_pn` FOREIGN KEY (`idphieunhap`) REFERENCES `phieunhap` (`idphieunhap`),
  CONSTRAINT `fk_pnsp` FOREIGN KEY (`idsanpham`) REFERENCES `sanpham` (`idsanpham`)
