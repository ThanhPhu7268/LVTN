...
CREATE TABLE `quantrivien` (
  ...
  `quantrivienten` varchar(255) DEFAULT NULL,
  `quantriviendiachi` varchar(255) DEFAULT NULL,
  `quantriviensdt` int DEFAULT NULL,
...
INSERT INTO `quantrivien` VALUES (1,'Nguyễn Trị Viên','An Giang',303030303);
