...
CREATE TABLE `kichthuoc` (
  ...
  `kichthuocmat` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idkichthuoc`)
...
INSERT INTO `kichthuoc` VALUES (1,'Dưới 25mm'),(2,'25mm đến 30mm'),(3,'30mm đến 35mm'),(4,'35mm đến 38mm'),(5,'38mm đến 40mm');
