...
CREATE TABLE `diachi` (
  ...
  `diachikhachhang` varchar(255) DEFAULT NULL,
  `idkhachhang` int DEFAULT NULL,
  PRIMARY KEY (`iddiachi`),
  KEY `fk_diachikh_idx` (`idkhachhang`),
  CONSTRAINT `fk_diachikh` FOREIGN KEY (`idkhachhang`) REFERENCES `khachhang` (`idkhachhang`)
