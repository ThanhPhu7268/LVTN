...
CREATE TABLE `loaimay` (
  `idloaimay` int NOT NULL,
  `loaimayten` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idloaimay`)
...
INSERT INTO `loaimay` VALUES (1,'Đồng Hồ Điện Tử (Quartz'),(2,'Đồng Hồ Cơ (Mechanical)');
